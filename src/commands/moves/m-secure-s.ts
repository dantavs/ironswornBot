...
export const rollSecureAdvantageShadow: Command = {
    data: new SlashCommandBuilder()
        .setName("secures")
        .setDescription("Roll Secure an Advantage(Shadow) move for you character")
    ...
    run: async (interaction) => {
        ...
        if (getChar.character){
            ...
            const checkRoll = CheckRoll({
                'attribute': getChar.character.shadow,
                'modifier': modifier,
                'portrait': getChar.character.portrait,
                'momentum': getChar.character.momentum,
                'title': 'Roll Secure an Advantage(Shadow)'
            })
