...
export const rollHeal: Command = {
    data: new SlashCommandBuilder()
        .setName("heal")
        .setDescription("Roll Heal move for you character")
    ...
    run: async (interaction) => {
        ...
        if (getChar.character){
            const stat = getChar.character.wits < getChar.character.iron? getChar.character.wits : getChar.character.iron
            ...
            const moveResultDescriptorMiss = new MoveDescriptor({
                resultName:'Miss',
                resultDescriptor : "Your aid is uneffective. Pay the Price."
            })
            
            let weakHitDescriptor = "Your care is helpful. If you (or the ally under your care) have the wounded condition, you may clear it. Then take or give up +2 health.\n"
            weakHitDescriptor += "Suffer -1 Supply or -1 Momentum (your choice)."
            ...
            const moveResultDescriptorStrongHit = new MoveDescriptor({
                ...
                resultDescriptor : 'Your care is helpful. If you (or the ally under your care) have the wounded condition, you may clear it. Then take or give up +2 health.'
            })
