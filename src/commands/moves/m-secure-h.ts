...
export const rollSecureAdvantageHeart: Command = {
    data: new SlashCommandBuilder()
        .setName("secureh")
        .setDescription("Roll Secure an Advantage(Heart) move for you character")
