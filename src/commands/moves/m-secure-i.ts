...
export const rollSecureAdvantageIron: Command = {
    data: new SlashCommandBuilder()
        .setName("securei")
        .setDescription("Roll Secure an Advantage (Iron) move for you character")
